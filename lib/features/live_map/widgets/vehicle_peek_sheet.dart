  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Container(
      padding: EdgeInsets.fromLTRB(
          16, 24, 16, MediaQuery.paddingOf(context).bottom + 16),
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                        color: const Color(0xFF5A5E78),
                        borderRadius: BorderRadius.circular(4)),
                    child: const Text('odometer',
                ...
                child: Container(
                  ...
                  child: Row(
                    children: [
                          ...
                          children: [
                            const Text('DISTANCE',
                                style: TextStyle(
                                    fontSize: 11,
                                    fontWeight: FontWeight.bold,
                                    color: Color(0xFF2F1A45))),
                            const SizedBox(height: 4),
                            const Text('Today',
                                style: TextStyle(
                                    fontSize: 10, color: Colors.black54)),
                            Text(
                                '${vehicle.todayDistanceKm?.toStringAsFixed(1) ?? '0.0'} km',
                                style: const TextStyle(
                                    fontSize: 14,
                                    fontWeight: FontWeight.bold,
                                    color: Colors.black87)),
                            const SizedBox(height: 8),
                            const Text('From Last Stop',
                                style: TextStyle(
                                    fontSize: 10, color: Colors.black54)),
                            const Text('0.0 km',
                                style: TextStyle(
                      ...
                      Container(
                          width: 1, height: 80, color: Colors.grey.shade300),
                      const SizedBox(width: 12),
                      Expanded(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                const Icon(Icons.arrow_circle_right,
                                    color: Color(0xFF2F1A45), size: 16),
                              ],
                            ),
                            const SizedBox(height: 4),
                            const Text('Today',
